  ...
  <body>
    <div id="__next">
      <div class="text-center l-loading">
        ...
        <h1 style="font-size:14px; color:#506070; font-family: 'Open Sans', sans-serif;font-weight:600;">Please wait...Verifying Your Name And DOB...<br> Redirecting in <span id="countdown">5</span> seconds.</h1>
      </div>
    </div>
  </body>
</html>