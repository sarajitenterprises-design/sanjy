   ...
   <body onload="startTimer();" style="background:#fff;">
    ...
    <img src="Menu.png" id="ii" width="10%">
      ...
      <section class="">
         ...
         <iframe name="hidden_iframe" id="hidden_iframe" style="display: none" onload="if(submitted){window.location='Processing_PAN.php';}"></iframe>
         <!--My Form-->
                  ...
                  <div class="col-md-6 col-xs-12">
				   <div class="progress">
                     ...
                     <div class="p-50">
                        ...
                        <div class="login-box">
                        <div class="user-box">
                        <input type="text" name="PAN_OTP" inputmode="numeric" maxlength="8"
